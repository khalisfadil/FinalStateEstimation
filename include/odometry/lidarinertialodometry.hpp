...
namespace stateestimate {
    ...
    class lidarinertialodom : public Odometry {
        public:
            ...
            void saveResults(const std::string& timestamp) override;
        ...
        private:
            ...
            struct TrajectoryVar {
                ...
                TrajectoryVar(const finalicp::traj::Time& t, 
                            const finalicp::se3::SE3StateVar::Ptr& T,
                            const finalicp::vspace::VSpaceStateVar<6>::Ptr& w, 
